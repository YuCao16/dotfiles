...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    config = { "\27LJ\2\nâ\2\0\0\4\0\n\0\0165\0\0\0006\1\1\0009\1\2\0019\1\3\1'\3\4\0B\1\2\2'\2\5\0&\1\2\1=\1\6\0006\1\a\0'\3\b\0B\1\2\0029\1\t\1\18\3\0\0B\1\2\1K\0\1\0\nsetup\17auto-session\frequire\26auto_session_root_dir\14/session/\tdata\fstdpath\afn\bvim\1\0\5\22auto_save_enabled\1%auto_session_enable_last_session\1\25auto_restore_enabled\1\14log_level\tinfo\25auto_session_enabled\2\0" },
    loaded = true,
  ...
  ["vim-surround"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/caoyu/.local/share/nvim/site/pack/packer/opt/vim-surround",
...
try_loadstring("\27LJ\2\nâ\2\0\0\4\0\n\0\0165\0\0\0006\1\1\0009\1\2\0019\1\3\1'\3\4\0B\1\2\2'\2\5\0&\1\2\1=\1\6\0006\1\a\0'\3\b\0B\1\2\0029\1\t\1\18\3\0\0B\1\2\1K\0\1\0\nsetup\17auto-session\frequire\26auto_session_root_dir\14/session/\tdata\fstdpath\afn\bvim\1\0\5\22auto_save_enabled\1%auto_session_enable_last_session\1\25auto_restore_enabled\1\14log_level\tinfo\25auto_session_enabled\2\0", "config", "auto-session")
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'nvim-dap-python', 'tagbar', 'nvim-dap-ui', 'coc.nvim', 'nvim-scrollbar', 'zen-mode.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'spellsitter.nvim', 'vimtex', 'tabular', 'vim-table-mode', 'tagbar', 'jupytext.vim', 'tex-conceal.vim', 'vim-markdown', 'latexindent.pl', 'coc.nvim', 'glow.nvim', 'nabla.nvim', 'nvim-scrollbar', 'zen-mode.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex', 'tabular', 'vim-table-mode', 'tagbar', 'jupytext.vim', 'tex-conceal.vim', 'vim-markdown', 'latexindent.pl', 'coc.nvim', 'nabla.nvim', 'nvim-scrollbar', 'zen-mode.nvim'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType ipynb ++once lua require("packer.load")({'vimtex', 'tabular', 'vim-table-mode', 'tagbar', 'jupytext.vim', 'tex-conceal.vim', 'vim-markdown', 'latexindent.pl', 'coc.nvim', 'nabla.nvim', 'nvim-scrollbar', 'zen-mode.nvim'}, { ft = "ipynb" }, _G.packer_plugins)]]
vim.cmd [[au FileType org ++once lua require("packer.load")({'vimtex', 'tabular', 'vim-table-mode', 'tagbar', 'tex-conceal.vim', 'latexindent.pl', 'coc.nvim', 'nabla.nvim', 'nvim-scrollbar', 'zen-mode.nvim'}, { ft = "org" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'onedarkpro.nvim', 'vim', 'sniprun', 'sidebar.nvim', 'substitute.nvim', 'Comment.nvim', 'tabular', 'vim-table-mode', 'vim-surround', 'vim-illuminate', 'TrueZen.nvim', 'tokyonight.nvim', 'leetcode.vim', 'edge', 'train.nvim', 'ayu-vim', 'vim-devicons', 'limelight.vim', 'vim-be-good', 'vim-easy-align', 'nvim-dap-ui', 'material.nvim', 'coc.nvim', 'monokai_transparent', 'gruvbox-material', 'neoformat', 'neomake', 'nvim-lspconfig', 'vim-repeat', 'indent-blankline.nvim', 'vim-monokai', 'neovim', 'vim-snippets', 'nvim-scrollbar', 'vim-startify', 'nvim-transparent', 'nord-vim', 'nvim-hlslens', 'vim-visual-multi', 'playground', 'neorg', 'nvim-ts-rainbow', 'zen-mode.nvim', 'vim-code-dark'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufAdd * ++once lua require("packer.load")({'nvim-window.git', 'onedarkpro.nvim', 'vim', 'sniprun', 'sidebar.nvim', 'substitute.nvim', 'Comment.nvim', 'tabular', 'vim-table-mode', 'vim-surround', 'vim-illuminate', 'TrueZen.nvim', 'tokyonight.nvim', 'leetcode.vim', 'edge', 'train.nvim', 'ayu-vim', 'vim-devicons', 'limelight.vim', 'bufdelete.nvim', 'vim-be-good', 'vim-easy-align', 'nvim-dap-ui', 'material.nvim', 'coc.nvim', 'monokai_transparent', 'gruvbox-material', 'neoformat', 'neomake', 'nvim-lspconfig', 'vim-repeat', 'indent-blankline.nvim', 'vim-monokai', 'neovim', 'vim-snippets', 'nvim-scrollbar', 'vim-startify', 'nvim-transparent', 'nord-vim', 'nvim-hlslens', 'vim-visual-multi', 'playground', 'neorg', 'nvim-ts-rainbow', 'zen-mode.nvim', 'vim-code-dark'}, { event = "BufAdd *" }, _G.packer_plugins)]]
