...
map("n", "<S-L>", ":exe 'vertical resize +5'<CR>", { noremap = true })
map("n", "<S-H>", ":exe 'vertical resize -5'<CR>", { noremap = true })
map("n", "<S-K>", ":exe 'resize -5'<CR>", { noremap = true })
map("n", "<S-J>", ":exe 'resize +5'<CR>", { noremap = true })
