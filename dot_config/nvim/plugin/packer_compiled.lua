...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    config = { "\27LJ\2\nâ\2\0\0\4\0\n\0\0165\0\0\0006\1\1\0009\1\2\0019\1\3\1'\3\4\0B\1\2\2'\2\5\0&\1\2\1=\1\6\0006\1\a\0'\3\b\0B\1\2\0029\1\t\1\18\3\0\0B\1\2\1K\0\1\0\nsetup\17auto-session\frequire\26auto_session_root_dir\14/session/\tdata\fstdpath\afn\bvim\1\0\5\14log_level\tinfo\25auto_restore_enabled\1\22auto_save_enabled\1\25auto_session_enabled\2%auto_session_enable_last_session\1\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\nâ\2\0\0\4\0\n\0\0165\0\0\0006\1\1\0009\1\2\0019\1\3\1'\3\4\0B\1\2\2'\2\5\0&\1\2\1=\1\6\0006\1\a\0'\3\b\0B\1\2\0029\1\t\1\18\3\0\0B\1\2\1K\0\1\0\nsetup\17auto-session\frequire\26auto_session_root_dir\14/session/\tdata\fstdpath\afn\bvim\1\0\5\14log_level\tinfo\25auto_restore_enabled\1\22auto_save_enabled\1\25auto_session_enabled\2%auto_session_enable_last_session\1\0", "config", "auto-session")
...
vim.cmd [[au FileType python ++once lua require("packer.load")({'zen-mode.nvim', 'nvim-dap-python', 'nvim-scrollbar', 'nvim-dap-ui', 'tagbar', 'coc.nvim'}, { ft = "python" }, _G.packer_plugins)]]
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'jupytext.vim', 'zen-mode.nvim', 'glow.nvim', 'vimtex', 'vim-markdown', 'nvim-scrollbar', 'tagbar', 'tex-conceal.vim', 'coc.nvim', 'tabular', 'vim-table-mode', 'spellsitter.nvim', 'nabla.nvim', 'latexindent.pl'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'jupytext.vim', 'zen-mode.nvim', 'vimtex', 'vim-markdown', 'nvim-scrollbar', 'tagbar', 'tex-conceal.vim', 'coc.nvim', 'tabular', 'vim-table-mode', 'nabla.nvim', 'latexindent.pl'}, { ft = "tex" }, _G.packer_plugins)]]
vim.cmd [[au FileType ipynb ++once lua require("packer.load")({'jupytext.vim', 'zen-mode.nvim', 'vimtex', 'vim-markdown', 'nvim-scrollbar', 'tagbar', 'tex-conceal.vim', 'coc.nvim', 'tabular', 'vim-table-mode', 'nabla.nvim', 'latexindent.pl'}, { ft = "ipynb" }, _G.packer_plugins)]]
vim.cmd [[au FileType org ++once lua require("packer.load")({'zen-mode.nvim', 'vimtex', 'nvim-scrollbar', 'tagbar', 'tex-conceal.vim', 'coc.nvim', 'tabular', 'vim-table-mode', 'nabla.nvim', 'latexindent.pl'}, { ft = "org" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'zen-mode.nvim', 'edge', 'vim-monokai', 'vim-visual-multi', 'sniprun', 'Comment.nvim', 'vim', 'vim-startify', 'nvim-ts-rainbow', 'vim-devicons', 'vim-be-good', 'nvim-scrollbar', 'vim-code-dark', 'vim-repeat', 'ayu-vim', 'nvim-hlslens', 'nvim-surround', 'nvim-dap-ui', 'train.nvim', 'vim-illuminate', 'tokyonight.nvim', 'vim-easy-align', 'coc.nvim', 'nord-vim', 'neorg', 'nvim-lspconfig', 'tabular', 'neovim', 'substitute.nvim', 'vim-table-mode', 'neomake', 'neoformat', 'playground', 'monokai_transparent', 'nvim-transparent', 'sidebar.nvim', 'material.nvim', 'onedarkpro.nvim', 'gruvbox-material', 'limelight.vim', 'vim-snippets'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufAdd * ++once lua require("packer.load")({'indent-blankline.nvim', 'zen-mode.nvim', 'edge', 'vim-monokai', 'vim-visual-multi', 'sniprun', 'Comment.nvim', 'nvim-window.git', 'vim', 'vim-startify', 'nvim-ts-rainbow', 'vim-devicons', 'vim-be-good', 'nvim-scrollbar', 'vim-code-dark', 'bufdelete.nvim', 'vim-repeat', 'ayu-vim', 'nvim-hlslens', 'nvim-surround', 'nvim-dap-ui', 'train.nvim', 'vim-illuminate', 'tokyonight.nvim', 'vim-easy-align', 'coc.nvim', 'nord-vim', 'neorg', 'nvim-lspconfig', 'tabular', 'neovim', 'substitute.nvim', 'vim-table-mode', 'neomake', 'neoformat', 'playground', 'monokai_transparent', 'nvim-transparent', 'sidebar.nvim', 'material.nvim', 'onedarkpro.nvim', 'gruvbox-material', 'limelight.vim', 'vim-snippets'}, { event = "BufAdd *" }, _G.packer_plugins)]]
