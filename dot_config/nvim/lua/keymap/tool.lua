...
local plug_map = {
	...
	["n|<leader>ch"] = map_cr("ToggleTerm direction=horizontal")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle horizontal"),
	["n|<leader>cv"] = map_cr("ToggleTerm direction=vertical")
		:with_noremap()
		:with_silent()
		:with_desc("terminal: Toggle vertical"),
	["n|<leader>cf"] = map_cr("ToggleTerm direction=float")
		:with_noremap()
		:with_silent()
	...
	-- Plugin: trouble
	["n|<leader>gt"] = map_cr("TroubleToggle"):with_noremap():with_silent():with_desc("lsp: Toggle trouble list"),
