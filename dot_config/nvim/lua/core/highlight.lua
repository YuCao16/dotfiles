...
if vim.g.colors_name == "tokyonight" then
	...
	if tk_colors_ok then
		...
		vim.api.nvim_set_hl(0, "IncSearch", { fg = "#1e2030",bg="#86c5d2", ctermfg = 9 })
	else
		return
	end
end
...
vim.api.nvim_set_hl(0, "IndentBlanklineIndent2", { fg = "#C0A36E", nocombine = true })
vim.api.nvim_set_hl(0, "IndentBlanklineIndent3", { fg = "#76946A", nocombine = true })
vim.api.nvim_set_hl(0, "IndentBlanklineIndent4", { fg = "#6A9689", nocombine = true })
vim.api.nvim_set_hl(0, "IndentBlanklineIndent5", { fg = "#658594", nocombine = true })
vim.api.nvim_set_hl(0, "IndentBlanklineIndent6", { fg = "#957FB8", nocombine = true })
